...
const data = [
  {
    id: 1,
    text: "Cuando llego a casa siempre hay una habitación a la que temo entrar.",
    image: '/assets/6.png',
  },
  {
    id: 2,
    text: "Cada vez que abro la puerta parece que el tiempo se haya esfumado, que me asome al precipicio del olvido y un viento frio me arroje a la nada",
    image: '/assets/9.png',
  },
  {
    id: 3,
    text: "Y como no, cada vez que mi mano toca el pomo, la misma puta pregunta en mi cabeza",
    image: "/assets/8.png",
  },
  {
    id: 4,
  ...
  {
    id: 5,
    text: "Entro a la habitación, tu te levantas de la silla y das un paso hacia mi",
    image: 'https://via.placeholder.com/1920x1080/FF00FF/FFFFFF/',
  },
  {
    id: 6,
    text: "Alargas tu mano llena de arrugas (una por cada derrota que te ha dado la vida), yo aprieto la mandibula e intento sonrreir",
    image: '/assets/5.png',
  },
  {
    id: 7,
  ...
  {
    id: 8,
    text: "Cojes mi mano, te acercas para observar mi rostro, yo reuno fuerzas para dibujar una sonrrisa, suspiro, tu tomas aliento y me dices, - Muchacho tu conoces a mi nieto? Hade mucho que no viene a verme",
    image: '/assets/3.png',
  },
  {
    id: 9,
...
const ImageScroller = () => {
  ...
  return (
    <div style={{ height: '100vh' }}>
      <h1 style={{ textAlign: 'center', marginTop: '50vh', marginBottom: '50vh' }}>
...
const getScrollEffect = (scrollYProgress, index) => {
  ...
  const middle = (index + 0.50) / data.length;
  ...
  switch (index) {
    case 0:
      imageTransform = useTransform(scrollYProgress, inputRange, ['scale(0.8)', 'scale(1)', 'scale(1.2)'].reverse());
      break;
    case 1:
      imageTransform = useTransform(scrollYProgress, inputRange, ['scale(1)', 'scale(1.5)', 'scale(2)'].reverse());
      break;
    // case 2:
    ...
    imageOpacity = useTransform(
      ...
      textOpacity = useTransform(scrollYProgress, inputRange, [1, 0.5, 0]); // Se desvanece mientras hace zoom
       break;
    case 4:
      imageTransform = useTransform(scrollYProgress, inputRange, ['scale(1)', 'scale(2)', 'scale(3)']);
      break;
    case 5:
      imageTransform = useTransform(scrollYProgress, inputRange, ['translateX(-100px)', 'translateX(0)', 'translateX(100px)']);
      break;
    case 9: // Imagen 7: zoom y desaparición
      imageTransform = useTransform(scrollYProgress, inputRange, ['scale(1.5)', 'scale(1.7)', 'scale(2)'].reverse());
      textOpacity = useTransform(scrollYProgress, inputRange, [1, 0.5, 0]); // Se desvanece mientras hace zoom
      break;
    case 10: // Imagen 8: simple, se muestra al aparecer en pantalla
      imageTransform = useTransform(scrollYProgress, inputRange, ['scale(1)', 'scale(1)', 'scale(1)']);
